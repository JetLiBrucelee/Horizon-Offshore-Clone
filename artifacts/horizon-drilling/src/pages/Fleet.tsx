    ...
    <main className="bg-[#0A0E1A] text-white">
      ...
      <section className="relative pt-40 pb-24 overflow-hidden">
        <div className="absolute inset-0" style={{
          backgroundImage: "radial-gradient(ellipse at 80% 30%, rgba(245,158,11,0.08) 0%, transparent 60%)"
        }} />
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 relative z-10">
          <ScrollReveal>
            <div className="flex items-center gap-3 mb-4">
              <div className="accent-line" />
              <span className="font-mono-custom text-[#F59E0B] text-xs tracking-[0.3em] uppercase">Our Fleet</span>
            </div>
            <h1 className="font-condensed font-black text-6xl lg:text-8xl uppercase tracking-tight mb-6">
              The World's<br /><span className="text-[#F59E0B]">Most Advanced</span><br />Fleet
            </h1>
            ...
            <div className="flex flex-wrap gap-8 mt-12">
              {[
                ...
                <div key={label} className="flex items-center gap-3">
                  <div className="font-condensed font-black text-4xl text-[#F59E0B]">{value}</div>
                    ...
                    <div className="grid grid-cols-4 divide-x divide-white/5 border-t border-white/5">
                      {[
                        ...
                        <div key={label} className="p-4 text-center">
                          <div className="font-mono-custom text-[#F59E0B] text-sm font-medium mb-1">{value}</div>
          ...
          <ScrollReveal delay={0.1}>
            <div className="relative bg-[#0D1629] border border-white/5 p-8">
              ...
              <svg viewBox="0 0 1200 600" className="w-full opacity-30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M120 200 L200 180 L280 190 L320 170 L380 185 L400 200 L380 220 L300 230 L200 225 Z" fill="#1E2D4A" stroke="#F59E0B" strokeWidth="0.5"/>
                <path d="M350 160 L500 140 L580 150 L620 170 L600 190 L560 210 L500 220 L420 215 L380 200 Z" fill="#1E2D4A" stroke="#F59E0B" strokeWidth="0.5"/>
                <path d="M500 130 L650 100 L750 110 L780 140 L760 160 L700 175 L640 170 L580 160 Z" fill="#1E2D4A" stroke="#F59E0B" strokeWidth="0.5"/>
                <path d="M650 90 L780 70 L860 80 L920 100 L940 130 L920 150 L880 160 L820 155 L760 140 L720 120 Z" fill="#1E2D4A" stroke="#F59E0B" strokeWidth="0.5"/>
                <path d="M200 250 L380 230 L400 260 L380 310 L320 360 L280 380 L220 370 L180 330 L160 280 Z" fill="#1E2D4A" stroke="#F59E0B" strokeWidth="0.5"/>
                <path d="M420 200 L560 210 L580 240 L560 290 L520 330 L480 350 L440 340 L410 300 L400 260 Z" fill="#1E2D4A" stroke="#F59E0B" strokeWidth="0.5"/>
                <path d="M620 160 L760 170 L800 200 L820 250 L800 300 L760 330 L700 340 L650 320 L620 280 L600 230 Z" fill="#1E2D4A" stroke="#F59E0B" strokeWidth="0.5"/>
                <path d="M780 140 L920 150 L980 180 L1020 220 L1040 270 L1020 320 L980 350 L930 360 L880 340 L840 300 L820 250 Z" fill="#1E2D4A" stroke="#F59E0B" strokeWidth="0.5"/>
                <path d="M880 160 L1020 150 L1100 170 L1150 200 L1160 240 L1140 270 L1080 280 L1020 260 L980 230 Z" fill="#1E2D4A" stroke="#F59E0B" strokeWidth="0.5"/>
                <path d="M580 350 L660 340 L700 380 L690 430 L640 460 L590 450 L555 410 Z" fill="#1E2D4A" stroke="#F59E0B" strokeWidth="0.5"/>
                <path d="M300 380 L380 370 L400 410 L380 460 L340 480 L290 470 L270 430 Z" fill="#1E2D4A" stroke="#F59E0B" strokeWidth="0.5"/>
                <path d="M960 380 L1060 360 L1120 390 L1140 440 L1100 470 L1040 480 L980 460 L950 420 Z" fill="#1E2D4A" stroke="#F59E0B" strokeWidth="0.5"/>
              </svg>
                ...
                {[
                  ...
                  >
                    <div className="w-3 h-3 bg-[#F59E0B] rounded-full relative">
                      <div className="absolute inset-0 bg-[#F59E0B] rounded-full animate-ping opacity-60" />
                    </div>
                    <div className="mt-1 font-mono-custom text-[9px] text-[#F59E0B] whitespace-nowrap">{label}</div>
                  </div>
                ))}
              </div>
            </div>
